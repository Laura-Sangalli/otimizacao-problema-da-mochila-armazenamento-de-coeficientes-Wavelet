...
Este repositório contém o código e o artigo de otimização computacional de uma variante do **Problema da Mochila Binária**. Eles foram desenvolvidos para a disciplina "Projeto de Algoritmos", do curso de Engenharia de Computação da UTFPR.
